      ...
      >
          ...
          <div className="mb-4 flex justify-center">
            <div className="relative">
              <div className="p-4 rounded-full bg-amber-600/20 border-2 border-amber-600/50">
                <Shield className="w-12 h-12 text-amber-400" aria-hidden="true" />
              </div>
              <Moon className="absolute -top-1 -right-1 w-6 h-6 text-amber-400" aria-hidden="true" />
            </div>
          </div>
        ...
        <motion.div className="space-y-3 mb-8" variants={itemVariants}>
          <div className="flex items-start gap-3">
            <Users className="w-5 h-5 text-emerald-400 mt-0.5 flex-shrink-0" aria-hidden="true" />
            <div>
          ...
          <div className="flex items-start gap-3">
            <Moon className="w-5 h-5 text-blue-400 mt-0.5 flex-shrink-0" aria-hidden="true" />
            <div>
          ...
          <div className="flex items-start gap-3">
            <Crown className="w-5 h-5 text-amber-500 mt-0.5 flex-shrink-0" aria-hidden="true" />
            <div>
        ...
        <motion.div className="space-y-3 mb-6" variants={itemVariants}>
          <Link to={ROUTES.NEW_GAME} className="block">
            <Button className="w-full bg-amber-600 hover:bg-amber-700 text-amber-950 font-semibold py-6 text-base" aria-label="Start a new game">
              New Game
            </Button>
          </Link>
          <Link to={ROUTES.CONTINUE} className="block">
            <Button variant="outline" className="w-full border-amber-700/50 text-amber-100 hover:bg-amber-900/20 py-6 text-base" aria-label="Continue a saved game">
              Continue Game
            </Button>
          </Link>
        </motion.div>
        ...
        <motion.div className="flex gap-3" variants={itemVariants}>
          <Link to={ROUTES.SETTINGS} className="flex-1">
            <Button variant="ghost" className="w-full text-gray-400 hover:text-amber-100 hover:bg-gray-800/50 text-sm" aria-label="Open settings">
              Settings
            </Button>
          </Link>
          <Link to={ROUTES.HELP} className="flex-1">
            <Button variant="ghost" className="w-full text-gray-400 hover:text-amber-100 hover:bg-gray-800/50 text-sm" aria-label="View game guide">
              Guide
            </Button>
          </Link>
        </motion.div>
